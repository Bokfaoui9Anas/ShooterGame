...
Shader "VertExmotion/Voodoo_LaunchOps/SliderRampSpecularRimReplaceColor"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom  exclude_path:deferred exclude_path:prepass vertex:vert addshadow
