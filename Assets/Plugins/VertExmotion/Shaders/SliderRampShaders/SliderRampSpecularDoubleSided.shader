...
Shader "VertExmotion/Voodoo_LaunchOps/SliderRampSpecularDoubleSided"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom addshadow exclude_path:deferred exclude_path:prepass vertex:vert addshadow
