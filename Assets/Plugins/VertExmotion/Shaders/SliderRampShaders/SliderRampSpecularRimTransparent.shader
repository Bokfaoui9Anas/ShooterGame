...
Shader "VertExmotion/Voodoo_LaunchOps/SliderRampSpecularRimTransparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom keepalpha exclude_path:deferred exclude_path:prepass vertex:vert addshadow
