...
Shader "VertExmotion/Voodoo_LaunchOps/SliderRampDissolve"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom fullforwardshadows addshadow exclude_path:deferred exclude_path:prepass vertex:vert addshadow
